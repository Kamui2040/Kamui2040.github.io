(() => {
  ...
  const HOME_ICON = `${ROOT}/assets/icons/k2040-home.webp`;
  ...
  const createFilledIcon = (key) => {
    ...
    path.setAttribute("d", FILLED_ICON_PATHS[key]);
    svg.append(path);
    icon.append(svg);
    return icon;
  };
  ...
  const createFamilyIcon = (key) => {
    ...
    if (key === "android") {
      ...
      svg.append(phone);
      appendStrokePath(svg, "M9.5 5h5M10 19h4");
    } else if (key === "gaming") {
      appendStrokePath(svg, "M7.2 7.2h9.6c2.3 0 4.2 1.7 4.6 4l.7 4.1c.3 1.8-1 3.5-2.9 3.5-1 0-1.9-.5-2.5-1.3l-1.4-1.9H8.7l-1.4 1.9c-.6.8-1.5 1.3-2.5 1.3-1.9 0-3.2-1.7-2.9-3.5l.7-4.1c.4-2.3 2.3-4 4.6-4Z");
      appendStrokePath(svg, "M7.5 10.3v4M5.5 12.3h4");
      const leftButton = document.createElementNS("http://www.w3.org/2000/svg", "circle");
      leftButton.setAttribute("cx", "16.5");
      leftButton.setAttribute("cy", "11.2");
      leftButton.setAttribute("r", ".9");
      const rightButton = document.createElementNS("http://www.w3.org/2000/svg", "circle");
      rightButton.setAttribute("cx", "18.6");
  ...
  const createHomeIcon = () => {
    const icon = document.createElement("span");
    icon.className = "k2040-icon k2040-icon--main";
    icon.setAttribute("aria-hidden", "true");
    icon.style.backgroundImage = `url("${HOME_ICON}")`;
    return icon;
  };
  ...
  const initGlobalMenu = (menu) => {
    if (menu.dataset.k2040ChromeReady === "true") return;
    menu.dataset.k2040ChromeReady = "true";
